...
class TestFileUtils(unittest.TestCase):
    ...
    def test_scan_folder(self):
        ...
        self.assertIn(self.test_file_path, file_list)
    ...
    def test_scan_folder_with_allow_extension(self):
        ...
        file_list = list(scan_folder(self.folder_path,
            allow_extension=['.txt']))
        self.assertIn(self.test_file_path, file_list)
        self.assertNotIn(self.test_file_path2, file_list)
    ...
    def test_scan_folder_with_ignore_extension(self):
        ...
        self.assertNotIn(self.test_file_path, file_list)
    ...
    def test_compose_file_name(self):
        ...
        composed_name, composed_path = compose_file_name(
        ...
        self.assertTrue(composed_name.startswith('test_file-'))
